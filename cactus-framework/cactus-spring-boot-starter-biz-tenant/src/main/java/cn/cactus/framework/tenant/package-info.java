/**
 * Package: cn.cactus.framework.tenant
 * Description:
 * 多租户，支持如下层面：
 ...
 *      1）Spring Async：
 *          {@link cn.cactus.framework.quartz.config.CactusAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 CactusSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
