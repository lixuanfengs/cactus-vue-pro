package cn.cactus.framework.social.core;

import cn.cactus.framework.social.core.enums.AuthExtendSource;
import cn.cactus.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 */
public class CactusAuthRequestFactory extends AuthRequestFactory {
    ...
    public CactusAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
    ...
    protected AuthRequest getExtendRequest(String source) {
        // TODO 仙人球：临时兼容 justauth 迁移的类型不对问题；
