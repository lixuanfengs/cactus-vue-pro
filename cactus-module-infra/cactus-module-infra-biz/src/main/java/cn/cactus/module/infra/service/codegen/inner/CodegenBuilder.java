package cn.cactus.module.infra.service.codegen.inner;
...
import cn.cactus.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.cactus.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import cn.cactus.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link cn.cactus.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.cactusli.net");
            return;
        }
        // reason
