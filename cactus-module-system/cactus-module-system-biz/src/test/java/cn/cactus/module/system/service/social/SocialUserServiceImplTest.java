...
import cn.cactus.module.system.dal.mysql.social.SocialUserBindMapper;
import cn.cactus.module.system.dal.mysql.social.SocialUserMapper;
...
import static cn.cactus.framework.common.util.json.JsonUtils.toJsonString;
...
import static cn.cactus.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
import static cn.cactus.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbUnitTest {
    ...
    @MockBean
    private CactusAuthRequestFactory authRequestFactory;
