...
import cn.cactus.framework.common.util.cache.CacheUtils;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    @Resource // 由于自定义了 CactusAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private CactusAuthRequestFactory cactusAuthRequestFactory;
    ...
    private AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = cactusAuthRequestFactory.get(SocialTypeEnum.valueOfType(socialType).getSource());
