...
import cn.cactus.module.system.dal.mysql.sms.SmsCodeMapper;
import cn.cactus.module.system.enums.sms.SmsSceneEnum;
import cn.cactus.module.system.framework.sms.SmsCodeProperties;
...
import static cn.cactus.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 仙人球：提升，每个 IP 每天可发送数量
            // TODO 仙人球：提升，每个 IP 每小时可发送数量
        }
